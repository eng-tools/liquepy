...
def calculate_fos():
    ...
    bi2014 = lq.trigger.run_bi2014(cpt, pga=0.25, magnitude=7.5)
...
def compare_fos():
    cpt = lq.field.load_cpt_from_file(TEST_DATA_DIR + "standard_1.csv")
    bi2014 = lq.trigger.BoulangerIdriss2014(cpt.depth, cpt.q_c, cpt.f_s, cpt.u_2, gwl=cpt.gwl, pga=0.25, magnitude=7.5,
                               a_ratio=cpt.a_ratio)
    factor_safety_values = bi2014.factor_of_safety
