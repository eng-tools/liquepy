...
def test_dist_wsg84_coords():
    ...
    c1 = map_coords.Coords(coords_1[0], coords_1[1])
    c2 = map_coords.Coords(coords_2[0], coords_2[1])
...
def test_calc_proj_line_dist_varied():
    ...
    coords0 = map_coords.Coords(lat=-43.51582324506836, lon=172.66865964340838)
    coords1 = map_coords.get_coords_at_dist(coords0, 0, 100)
    coords2 = map_coords.get_coords_at_dist(coords0, 0, 50)
    line = map_coords.Line(coords0, coords1)
...
def test_calc_proj_line_dist():
    ...
    e = 1573209.09
    n = 5181989.69
    coords1 = map_coords.Coords(lat=-43.51455326888498, lon=172.6685304953782)
    print(coords1.lat, coords1.lon)

    # CPT_15616
    e = 1573207.3
    n = 5181902.36
    coords2 = map_coords.Coords(lat=-43.51533655610677, lon=172.66850146287283)
    print(coords2.lat, coords2.lon)
    line = map_coords.Line(coords0, coords1)
    line_r = map_coords.Line(coords1, coords0)
