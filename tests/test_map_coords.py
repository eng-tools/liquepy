...
def test_calc_proj_line_dist_varied():
    ...
    coords0 = liquepy._spatial_models.Coords(
        lat=-43.51582324506836, lon=172.66865964340838
    )
...
def test_calc_proj_line_dist():
    ...
    e = 1573209.09
    n = 5181989.69
    coords1 = liquepy._spatial_models.Coords(
        lat=-43.51455326888498, lon=172.6685304953782
    )
    ...
    e = 1573207.3
    n = 5181902.36
    coords2 = liquepy._spatial_models.Coords(
        lat=-43.51533655610677, lon=172.66850146287283
    )
